...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO ABBC", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "WK8APjE7ot9Ngg7jbp9cndDkjUwAq62UFb")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	walletID := "WK8APjE7ot9Ngg7jbp9cndDkjUwAq62UFb"
	account := &openwallet.AssetsAccount{Alias: "abbcopenwtes", WalletID: walletID, Required: 1, Symbol: "ABBC", IsTrust: true}
...
func TestWalletManager_CreateAddress(t *testing.T) {
	...
	walletID := "WK8APjE7ot9Ngg7jbp9cndDkjUwAq62UFb"
	accountID := "4G1TovuPuepea6KLyFi7qSL85NxzY5rixK1pdBAVwBsg"
